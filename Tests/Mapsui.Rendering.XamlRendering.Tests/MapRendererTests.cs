...
namespace Mapsui.Rendering.XamlRendering.Tests
{
  ...
  var canvas = new Canvas();
        ...
        private static MemoryProvider CreatePolygonProvider()
        {
        ...
        private static MemoryProvider CreateLineProvider()
        {
            ...
            feature.Styles.Add(new VectorStyle { Fill = new Brush(Color.Blue), Line = new Pen(Color.Blue, 3), Outline = new Pen(Color.Blue, 3), Enabled = true });
            provider.Features.Add(feature);
