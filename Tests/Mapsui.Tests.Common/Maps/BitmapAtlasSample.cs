...
public class BitmapAtlasSample : ISample
{
    ...
    public static List<IFeature> CreateFeatures()
    {
        ...
        var bitmapPath = typeof(BitmapAtlasSample).LoadSvgPath("Resources.Images.Ghostscript_Tiger.svg");
        ...
        return new List<IFeature>
        {
            ...
            {
                Styles = new[] {new SymbolStyle { BitmapPath = bitmapPath, SymbolScale = 0.1} }
            }
        };
    }
}
