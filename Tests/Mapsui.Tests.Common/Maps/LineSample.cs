...
namespace Mapsui.Tests.Common.Maps
{
    public class LineSample : ISample
    {
        ...
        private static MemoryProvider<IGeometryFeature> CreateLineProvider()
        {
            ...
            features.Add(feature);
            feature = new Feature { Geometry = Geometry.GeomFromText("LINESTRING (-7000000 9750000, -1000000 9750000)") };
            feature.Styles.Add(new VectorStyle { Line = new Pen(Color.Blue) { PenStyle = PenStyle.LongDash, DashOffset = 2 } });
            features.Add(feature);
            feature = new Feature { Geometry = Geometry.GeomFromText("LINESTRING (-7000000 9500000, -1000000 9500000)") };
            feature.Styles.Add(new VectorStyle { Line = new Pen(Color.Blue) { PenStyle = PenStyle.LongDash, DashOffset = 4 } });
            features.Add(feature);
            feature = new Feature { Geometry = Geometry.GeomFromText("LINESTRING (-7000000 9250000, -1000000 9250000)") };
            feature.Styles.Add(new VectorStyle { Line = new Pen(Color.Blue) { PenStyle = PenStyle.LongDash, DashOffset = 6 } });
            features.Add(feature);
            feature = new Feature { Geometry = Geometry.GeomFromText("LINESTRING (-7000000 9000000, -1000000 9000000)") };
            ...
            features.Add(feature);
            feature = new Feature { Geometry = Geometry.GeomFromText("LINESTRING (00000 9750000, 6000000 9750000)") };
            ...
            features.Add(feature);
            feature = new Feature { Geometry = Geometry.GeomFromText("LINESTRING (00000 9500000, 6000000 9500000)") };
            ...
            features.Add(feature);
            feature = new Feature { Geometry = Geometry.GeomFromText("LINESTRING (00000 9250000, 6000000 9250000)") };
            ...
            features.Add(feature);
            feature = new Feature { Geometry = Geometry.GeomFromText("LINESTRING (00000 9000000, 6000000 9000000)") };
