...
namespace Mapsui.Tests.Common.Maps
{
    public class LineSample : ISample
    {
        ...
        private static GeometryMemoryProvider<IFeature> CreateLineProvider()
        {
            ...
            feature = new GeometryFeature { Geometry = Geometry.GeomFromText("LINESTRING (-7000000 12000000, -1000000 12000000)") };
            feature.Styles.Add(new VectorStyle { Line = new Pen(Color.Red) { PenStyle = PenStyle.Dash } });
            features.Add(feature);
            feature = new GeometryFeature { Geometry = Geometry.GeomFromText("LINESTRING (00000 12000000, 6000000 12000000)") };
            feature.Styles.Add(new VectorStyle { Line = new Pen(Color.Green) { PenStyle = PenStyle.ShortDash } });
            features.Add(feature);
            feature = new GeometryFeature { Geometry = Geometry.GeomFromText("LINESTRING (7000000 12000000, 13000000 12000000)") };
            feature.Styles.Add(new VectorStyle { Line = new Pen(Color.Blue) { PenStyle = PenStyle.DashDot } });
            features.Add(feature);
            feature = new GeometryFeature { Geometry = Geometry.GeomFromText("LINESTRING (14000000 12000000, 20000000 12000000)") };
            feature.Styles.Add(new VectorStyle { Line = new Pen(Color.Red) { PenStyle = PenStyle.ShortDashDot } });
            features.Add(feature);
            feature = new GeometryFeature { Geometry = Geometry.GeomFromText("LINESTRING (-7000000 11000000, -1000000 11000000)") };
            feature.Styles.Add(new VectorStyle { Line = new Pen(Color.Green) { PenStyle = PenStyle.DashDotDot } });
            features.Add(feature);
            feature = new GeometryFeature { Geometry = Geometry.GeomFromText("LINESTRING (000000 11000000, 6000000 11000000)") };
            feature.Styles.Add(new VectorStyle { Line = new Pen(Color.Blue) { PenStyle = PenStyle.ShortDashDotDot } });
            features.Add(feature);
            feature = new GeometryFeature { Geometry = Geometry.GeomFromText("LINESTRING (7000000 11000000, 13000000 11000000)") };
            feature.Styles.Add(new VectorStyle { Line = new Pen(Color.Red) { PenStyle = PenStyle.Dot } });
            features.Add(feature);
            feature = new GeometryFeature { Geometry = Geometry.GeomFromText("LINESTRING (14000000 11000000, 20000000 11000000)") };
            feature.Styles.Add(new VectorStyle { Line = new Pen(Color.Green) { PenStyle = PenStyle.ShortDot } });
            features.Add(feature);
            feature = new GeometryFeature { Geometry = Geometry.GeomFromText("LINESTRING (-7000000 10000000, -1000000 10000000)") };
            feature.Styles.Add(new VectorStyle { Line = new Pen(Color.Blue) { PenStyle = PenStyle.LongDash } });
            features.Add(feature);
            feature = new GeometryFeature { Geometry = Geometry.GeomFromText("LINESTRING (-7000000 9750000, -1000000 9750000)") };
            feature.Styles.Add(new VectorStyle { Line = new Pen(Color.Blue) { PenStyle = PenStyle.LongDash, DashOffset = 2 } });
            features.Add(feature);
            feature = new GeometryFeature { Geometry = Geometry.GeomFromText("LINESTRING (-7000000 9500000, -1000000 9500000)") };
            feature.Styles.Add(new VectorStyle { Line = new Pen(Color.Blue) { PenStyle = PenStyle.LongDash, DashOffset = 4 } });
            features.Add(feature);
            feature = new GeometryFeature { Geometry = Geometry.GeomFromText("LINESTRING (-7000000 9250000, -1000000 9250000)") };
            feature.Styles.Add(new VectorStyle { Line = new Pen(Color.Blue) { PenStyle = PenStyle.LongDash, DashOffset = 6 } });
            features.Add(feature);
            feature = new GeometryFeature { Geometry = Geometry.GeomFromText("LINESTRING (-7000000 9000000, -1000000 9000000)") };
            feature.Styles.Add(new VectorStyle { Line = new Pen(Color.Blue) { PenStyle = PenStyle.LongDash, DashOffset = 8 } });
            features.Add(feature);
            feature = new GeometryFeature { Geometry = Geometry.GeomFromText("LINESTRING (00000 10000000, 6000000 10000000)") };
            ...
            features.Add(feature);
            feature = new GeometryFeature { Geometry = Geometry.GeomFromText("LINESTRING (00000 9750000, 6000000 9750000)") };
            ...
            features.Add(feature);
            feature = new GeometryFeature { Geometry = Geometry.GeomFromText("LINESTRING (00000 9500000, 6000000 9500000)") };
            ...
            features.Add(feature);
            feature = new GeometryFeature { Geometry = Geometry.GeomFromText("LINESTRING (00000 9250000, 6000000 9250000)") };
            ...
            features.Add(feature);
            feature = new GeometryFeature { Geometry = Geometry.GeomFromText("LINESTRING (00000 9000000, 6000000 9000000)") };
            ...
            features.Add(feature);
            feature = new GeometryFeature { Geometry = Geometry.GeomFromText("LINESTRING (7000000 10000000, 13000000 10000000)") };
            feature.Styles.Add(new VectorStyle { Line = new Pen(Color.Green) { PenStyle = PenStyle.LongDashDot } });
            features.Add(feature);
            feature = new GeometryFeature { Geometry = Geometry.GeomFromText("LINESTRING (14000000 10000000, 20000000 10000000)") };
            feature.Styles.Add(new VectorStyle { Line = new Pen(Color.Blue) { PenStyle = PenStyle.Solid } });
            features.Add(feature);

            feature = new GeometryFeature { Geometry = Geometry.GeomFromText("LINESTRING (-7000000 7500000, -3725000 7500000, -3725000 6500000, -1000000 6500000)") };
            ...
            features.Add(feature);
            feature = new GeometryFeature { Geometry = Geometry.GeomFromText("LINESTRING (000000 7500000, 3000000 7500000, 3000000 6500000, 6000000 6500000)") };
            ...
            feature.Styles.Add(new VectorStyle { Line = new Pen(Color.Red) { PenStyle = PenStyle.Solid, PenStrokeCap = PenStrokeCap.Butt } });
            features.Add(feature);
            feature = new GeometryFeature { Geometry = Geometry.GeomFromText("LINESTRING (7500000 7500000, 10000000 7500000, 10000000 6500000, 12500000 6500000)") };
