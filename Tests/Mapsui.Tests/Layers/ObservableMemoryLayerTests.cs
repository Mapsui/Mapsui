...
[TestFixture]
public class ObservableMemoryLayerTests
{
    [Test]
    public void ObservableMemoryLayer_WithObservableCollection_ShouldPopulateFeatures()
    {
        // Arrange
        ...
        // Act
        using var layer = new ObservableMemoryLayer<TestItem>(item => new PointFeature(item.X, item.Y))
        {
    ...
    [Test]
    public void ObservableMemoryLayer_AddItem_ShouldAddFeature()
    {
        // Arrange
        var collection = new ObservableCollection<TestItem>
        {
    ...
    [Test]
    public void ObservableMemoryLayer_RemoveItem_ShouldRemoveFeature()
    {
        // Arrange
    ...
    [Test]
    public void ObservableMemoryLayer_ReplaceItem_ShouldUpdateFeature()
    {
        // Arrange
        var collection = new ObservableCollection<TestItem>
        {
    ...
    [Test]
    public void ObservableMemoryLayer_ClearCollection_ShouldClearFeatures()
    {
        // Arrange
        var collection = new ObservableCollection<TestItem>
        {
    ...
    [Test]
    public void ObservableMemoryLayer_WithCustomINotifyCollectionChanged_ShouldWork()
    {
        // Arrange
    ...
    [Test]
    public void ObservableMemoryLayer_SetToNull_ShouldClearFeatures()
    {
        // Arrange
        var collection = new ObservableCollection<TestItem>
        {
    ...
    [Test]
    public void ObservableMemoryLayer_ReplaceCollection_ShouldUnsubscribeFromOld()
    {
        // Arrange
