...
public partial class MapPage : ContentPage
{
    ...
    private void MyLocationPositionChanged(object sender, PositionEventArgs e)
    {
        Device.BeginInvokeOnMainThread(() =>
        {
            ...
            mapView.MyLocationLayer.UpdateMyDirection(e.Position.Heading, mapView.Map.Navigator.State.Rotation);
    ...
    {
        mapView.MyLocationLayer.UpdateMyViewDirection(e.Reading.HeadingMagneticNorth, mapView.Map.Navigator.State.Rotation, false);
    }
