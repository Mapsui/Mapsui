...
public static class MapTilesDeployer
{
    ...
    {
        assembly.CopyEmbeddedResourceToFile(@$"Mapsui.Samples.Common.Resources.GeoData.{mapTile}.{resourceFolder}.", MapTileLocation + @$"{Path.DirectorySeparatorChar}{mapTile}{Path.DirectorySeparatorChar}{folder}{Path.DirectorySeparatorChar}", $"{tile}.png");
    }
}
