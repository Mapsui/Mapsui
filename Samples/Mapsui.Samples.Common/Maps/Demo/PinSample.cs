...
public class PinSample : ISample
{
    ...
    public static Map CreateMap()
    {
        ...
        layer.AddMarker(SphericalMercator.FromLonLat(9.0, 48.025), title: "New York", type: Features.MarkerType.Pin)
            .AddMarker(SphericalMercator.FromLonLat(9.1, 48.0), title: "Ghostscript Tiger", svg: tiger, scale: 0.1, anchor: new Offset(0.3, -0.8, true), calloutAnchor: new Offset(-0.3, -0.3, true)) // Set center point to 30 % in x and -80 % in y direction
            .AddMarker(SphericalMercator.FromLonLat(9.05, 48.0), title: "San Fransisco", icon: icon, anchor: new Offset(0.5, 0.5, true), calloutAnchor: new Offset(-0.5, 1.0, true));
