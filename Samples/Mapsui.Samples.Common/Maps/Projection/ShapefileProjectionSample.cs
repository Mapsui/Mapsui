...
#pragma warning restore IDISP004 // Dispose created
    ...
    private static IThemeStyle CreateCityTheme()
    {
        ...
        var bitmapPath = typeof(ShapefileProjectionSample).LoadBitmapPath(@"Images.icon.png");
        var cityMin = new SymbolStyle { BitmapPath = bitmapPath, SymbolScale = 0.5f };
        var cityMax = new SymbolStyle { BitmapPath = bitmapPath, SymbolScale = 1f };
