...
public class LineSample : ISample
{
    ...
    private static List<IFeature> CreateLineFeatures()
    {
        ...
        feature.Styles.Add(new VectorStyle
        {
            Line = new Pen(Color.Red) { PenStyle = PenStyle.Dash },
            Outline = null,
        });
        features.Add(feature);
        ...
        feature.Styles.Add(new VectorStyle
        {
            Line = new Pen(Color.Green) { PenStyle = PenStyle.ShortDash },
            Outline = null
        });
        features.Add(feature);
        ...
        feature.Styles.Add(new VectorStyle
        {
            Line = new Pen(Color.Blue) { PenStyle = PenStyle.DashDot },
            Outline = null
        });
        features.Add(feature);
        ...
        feature.Styles.Add(new VectorStyle
        {
            Line = new Pen(Color.Red) { PenStyle = PenStyle.ShortDashDot },
            Outline = null
        });
        features.Add(feature);
        ...
        feature.Styles.Add(new VectorStyle
        {
            Line = new Pen(Color.Green) { PenStyle = PenStyle.DashDotDot },
            Outline = null
        });
        features.Add(feature);
        ...
        feature.Styles.Add(new VectorStyle
        {
            Line = new Pen(Color.Blue) { PenStyle = PenStyle.ShortDashDotDot },
            Outline = null
        });
        features.Add(feature);
        ...
        feature.Styles.Add(new VectorStyle
        {
            Line = new Pen(Color.Red) { PenStyle = PenStyle.Dot },
            Outline = null
        });
        features.Add(feature);
        ...
        feature.Styles.Add(new VectorStyle
        {
            Line = new Pen(Color.Green) { PenStyle = PenStyle.ShortDot },
            Outline = null
        });
        features.Add(feature);
        ...
        feature.Styles.Add(new VectorStyle
        {
            Line = new Pen(Color.Blue) { PenStyle = PenStyle.LongDash },
            Outline = null
        });
        features.Add(feature);
        ...
        feature.Styles.Add(new VectorStyle
        {
            Line = new Pen(Color.Blue) { PenStyle = PenStyle.LongDash, DashOffset = 2 },
            Outline = null
        });
        features.Add(feature);
        ...
        feature.Styles.Add(new VectorStyle
        {
            Line = new Pen(Color.Blue) { PenStyle = PenStyle.LongDash, DashOffset = 4 },
            Outline = null
        });
        features.Add(feature);
        ...
        feature.Styles.Add(new VectorStyle
        {
            Line = new Pen(Color.Blue) { PenStyle = PenStyle.LongDash, DashOffset = 6 },
            Outline = null
        });
        features.Add(feature);
        ...
        feature.Styles.Add(new VectorStyle
        {
            Line = new Pen(Color.Blue) { PenStyle = PenStyle.LongDash, DashOffset = 8 },
            Outline = null
        });
        features.Add(feature);
        ...
        feature.Styles.Add(new VectorStyle
        {
            Line = new Pen(Color.Red) { PenStyle = PenStyle.UserDefined, DashArray = new float[] { 6, 4, 12, 4, 2, 4, 12, 4 } },
            Outline = null
        });
        features.Add(feature);
        ...
        feature.Styles.Add(new VectorStyle
        {
            Line = new Pen(Color.Red) { PenStyle = PenStyle.UserDefined, DashArray = new float[] { 6, 4, 12, 4, 2, 4, 12, 4 }, DashOffset = 5 },
            Outline = null
        });
        features.Add(feature);
        ...
        feature.Styles.Add(new VectorStyle
        {
            Line = new Pen(Color.Red) { PenStyle = PenStyle.UserDefined, DashArray = new float[] { 6, 4, 12, 4, 2, 4, 12, 4 }, DashOffset = 10 },
            Outline = null
        });
        features.Add(feature);
        ...
        feature.Styles.Add(new VectorStyle
        {
            Line = new Pen(Color.Red) { PenStyle = PenStyle.UserDefined, DashArray = new float[] { 6, 4, 12, 4, 2, 4, 12, 4 }, DashOffset = 15 },
            Outline = null
        });
        features.Add(feature);
        ...
        feature.Styles.Add(new VectorStyle
        {
            Line = new Pen(Color.Red) { PenStyle = PenStyle.UserDefined, DashArray = [6, 4, 12, 4, 2, 4, 12, 4], DashOffset = 20 },
            Outline = null
        });
        features.Add(feature);
        ...
        feature.Styles.Add(new VectorStyle
        {
            Line = new Pen(Color.Green) { PenStyle = PenStyle.LongDashDot },
            Outline = null
        });
        features.Add(feature);
        ...
        feature.Styles.Add(new VectorStyle
        {
            Line = new Pen(Color.Blue) { PenStyle = PenStyle.Solid },
            Outline = null
        });
        features.Add(feature);
        ...
        feature.Styles.Add(new VectorStyle
        {
            Line = new Pen(Color.Gray, 15) { PenStyle = PenStyle.Solid, PenStrokeCap = PenStrokeCap.Butt, StrokeJoin = StrokeJoin.Bevel, StrokeMiterLimit = 1 },
            Outline = null
        });
        feature.Styles.Add(new VectorStyle
        {
            Line = new Pen(Color.Red) { PenStyle = PenStyle.Solid, PenStrokeCap = PenStrokeCap.Butt },
            Outline = null
        });
        features.Add(feature);
        ...
        feature.Styles.Add(new VectorStyle
        {
            Line = new Pen(Color.Gray, 15) { PenStyle = PenStyle.Solid, PenStrokeCap = PenStrokeCap.Round, StrokeJoin = StrokeJoin.Round, StrokeMiterLimit = 1 },
            Outline = null
        });
        feature.Styles.Add(new VectorStyle
        {
        ...
        feature.Styles.Add(new VectorStyle
        {
            Line = new Pen(Color.Gray, 15) { PenStyle = PenStyle.Solid, PenStrokeCap = PenStrokeCap.Square, StrokeJoin = StrokeJoin.Miter },
            Outline = null
        });
        feature.Styles.Add(new VectorStyle
        {
