...
namespace Mapsui.Samples.Common.Maps
{
    public class AnimationsSample : ISample
    {
        ...
        public static ILayer CreateLayer()
        {
            ...
            {
                DataSource = new MemoryProvider(CreatePoints()),
            };
        }

        private static List<Feature> CreatePoints()
        {
            var result = new List<Feature>();

            result.Add(CreatePoint(1000000, 1000000));
            result.Add(CreatePoint(9000000, 1000000));
            result.Add(CreatePoint(9000000, 9000000));
            result.Add(CreatePoint(1000000, 9000000));
