...
public class ScaleBarSample : ISample
{
    ...
    public Task<Map> CreateMapAsync()
    {
        ...
        map.Widgets.Add(new ScaleBarWidget(map) { MaxWidth = 250, ShowEnvelop = true, Font = new Font { FontFamily = "sans serif", Size = 24 }, TickLength = 15, TextColor = new Color(240, 120, 24, 128), Halo = new Color(250, 168, 48, 128), HorizontalAlignment = Mapsui.Widgets.HorizontalAlignment.Absolute, VerticalAlignment = Mapsui.Widgets.VerticalAlignment.Absolute, TextAlignment = Mapsui.Widgets.Alignment.Left, ScaleBarMode = ScaleBarMode.Both, SecondaryUnitConverter = NauticalUnitConverter.Instance, PositionX = 100, PositionY = 100 });
