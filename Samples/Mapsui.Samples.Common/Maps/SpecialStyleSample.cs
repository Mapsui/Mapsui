...
namespace Mapsui.Samples.Common.Maps
{
    ...
    public class SpecialStyleRenderer : ISkiaStyleRenderer
    {
    ...
    public class SpecialStyleSample : ISample
    {
        ...
        public void Setup(IMapControl mapControl)
        {
            ...
            if (mapControl.Renderer is Rendering.Skia.MapRenderer)
                mapControl.Renderer.StyleRenderers.Add(typeof(SpecialStyle), new SpecialStyleRenderer());
        }
