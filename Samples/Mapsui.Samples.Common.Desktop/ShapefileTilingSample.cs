...
namespace Mapsui.Samples.Common.Desktop
{
    ...
    {
        public string Name => "4 Shapefile with labels (Tiling)";
        ...
        public static Map CreateMap()
        {
            ...
            map.Layers.Add(new RasterizingTileLayer(CreateCityLayer(citySource)));
            map.Layers.Add(new RasterizingTileLayer(CreateCountryLabelLayer(countrySource)));
            map.Layers.Add(new RasterizingTileLayer(CreateCityLabelLayer(citySource)));
