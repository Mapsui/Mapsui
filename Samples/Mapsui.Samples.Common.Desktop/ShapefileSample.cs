...
namespace Mapsui.Samples.Common.Desktop
{
    public static class ShapefileSample
    {
        public static Map CreateMap()
        {
            ...
            //turn off extra layers by default
            map.Layers.FindLayer("Country labels").First().Enabled = false;
            map.Layers.FindLayer("Cities").First().Enabled = false;
            map.Layers.FindLayer("City labels").First().Enabled = false;
