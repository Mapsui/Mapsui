...
The most straightforward way to port from V4 to V5 is to create a new class with an IsMapInfoLayer field and assign an instance to the ILayer.Tag field. 
