...
In Mapsui v5 the Image class was added which simplifies the process of assigning images to symbols. Previously, in v4, you had to load the image in your code, register it, and then assign the image ID returned from the registration to the symbol. With v5, you can directly assign the path to the Image.Source of the symbol.
...
### Types with an Image.Source
In Mapsui 5.0.0-beta.2 the following types support the Image.Source path:
