...
Copy-Item -Path ".\Tests\Mapsui.Rendering.Skia.Tests\bin\Debug\net9.0\Resources\Images\GeneratedTest\*" -Destination ".\Tests\Mapsui.Rendering.Skia.Tests\Resources\Images\OriginalTest" -Force
Copy-Item -Path ".\Tests\Mapsui.Rendering.Skia.Tests\bin\Debug\net9.0\Resources\Images\GeneratedRegression\*" -Destination ".\Tests\Mapsui.Rendering.Skia.Tests\Resources\Images\OriginalRegression" -Force
