...
REM nuget push .\Artifacts\Mapsui.Android.%VERSION%.nupkg -source nuget.org || exit /B 1
REM nuget push .\Artifacts\Mapsui.Uno.%VERSION%.nupkg -source nuget.org || exit /B 1
REM nuget push .\Artifacts\Mapsui.Uwp.%VERSION%.nupkg -source nuget.org || exit /B 1
REM nuget push .\Artifacts\Mapsui.WinUI.%VERSION%.nupkg -source nuget.org || exit /B 1
REM nuget push .\Artifacts\Mapsui.ArcGIS.%VERSION%.nupkg -source nuget.org || exit /B 1
