...
When working in this area, load and read `.agents/skills/richtextkit/SKILL.md` for the full RichTextKit reference (usage patterns, FontMapper, pitfalls, performance notes).
