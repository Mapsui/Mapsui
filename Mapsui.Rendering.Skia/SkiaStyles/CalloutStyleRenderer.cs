...
public class CalloutStyleRenderer : ISkiaStyleRenderer
{
        ...
        RenderService renderService, long iteration)
    {
        ...
        var drawableImage = (SvgImage)renderService.DrawableImageCache.GetOrCreate(calloutStyle.ImageIdOfCallout,
            () => new SvgImage(calloutStyle.ToCalloutBalloonStyle().CreateCallout(contentDrawableImage.Picture)))!;
        ...
        var balloonBounds = calloutStyle.ToCalloutBalloonStyle().GetBalloonBounds(contentDrawableImage.Picture.GetSize());
