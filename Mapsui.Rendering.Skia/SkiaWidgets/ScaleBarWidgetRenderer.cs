...
public class ScaleBarWidgetRenderer : ISkiaWidgetRenderer, IDisposable
{
        ...
        float layerOpacity)
    {
        ...
        using var fontHolder = SkiaFontCache.GetOrCreate(scaleBar.Font,
            (float)((scaleBar.Font?.Size ?? 10) * scaleBar.Scale), renderService,
            boldOverride: true, edging: SKFontEdging.SubpixelAntialias);
        var scaleTextFont = fontHolder.Instance;
        ...
        scaleTextFont.MeasureText("9999 m", out var textSize, _paintScaleTextStroke);
        ...
        scaleTextFont.MeasureText(scaleBarText1, out var textSize1, _paintScaleTextStroke);
        ...
        if (scaleBar.ScaleBarMode == ScaleBarMode.Both && scaleBar.SecondaryUnitConverter != null)
        {
            ...
            scaleTextFont.MeasureText(scaleBarText2, out textSize2, _paintScaleTextStroke);
        }
        ...
        // Now draw text
        canvas.DrawText(scaleBarText1, (float)posX1, (float)(posY1 - textSize1.Top), SKTextAlign.Left, scaleTextFont, _paintScaleTextStroke);
        canvas.DrawText(scaleBarText1, (float)posX1, (float)(posY1 - textSize1.Top), SKTextAlign.Left, scaleTextFont, _paintScaleText);
        ...
        if (scaleBar.ScaleBarMode == ScaleBarMode.Both && scaleBar.SecondaryUnitConverter != null)
        {
            ...
            canvas.DrawText(scaleBarText2, (float)posX2, (float)(posY2 - textSize2.Top), SKTextAlign.Left, scaleTextFont, _paintScaleTextStroke);
            canvas.DrawText(scaleBarText2, (float)posX2, (float)(posY2 - textSize2.Top), SKTextAlign.Left, scaleTextFont, _paintScaleText);
