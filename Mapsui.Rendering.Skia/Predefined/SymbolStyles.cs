...
{
    public static SymbolStyle CreatePinStyle(Color? pinColor = null)
    {
        ...
        // It should be possible to create a style with just a resource.
        // The conversion to an image should happen in a render phase that
