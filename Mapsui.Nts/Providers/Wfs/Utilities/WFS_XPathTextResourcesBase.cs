...
public class WFS_XPathTextResourcesBase
{
    ...
    /// </summary>
    public static string NSOGCPREFIX => _NSOGCPREFIX;

    /// <summary>
    /// OGC namespace URI 
    /// </summary>
    public static string NSOGC => _NSOGC;

    /// <summary>
    /// Prefix used for XLink namespace
    /// </summary>
    public static string NSXLINKPREFIX => _NSXLINKPREFIX;

    /// <summary>
    /// XLink namespace URI 
    /// </summary>
    public static string NSXLINK => _NSXLINK;

    /// <summary>
    /// Prefix used for feature namespace
    /// </summary>
    public static string NSFEATURETYPEPREFIX => _NSFEATURETYPEPREFIX;

    /// <summary>
    /// Prefix used for WFS namespace
    /// </summary>
    public static string NSWFSPREFIX => _NSWFSPREFIX;

    /// <summary>
    /// WFS namespace URI 
    /// </summary>
    public static string NSWFS => _NSWFS;

    /// <summary>
    /// Prefix used for GML namespace
    /// </summary>
    public static string NSGMLPREFIX => _NSGMLPREFIX;

    /// <summary>
    /// GML namespace URI 
    /// </summary>
    public static string NSGML => _NSGML;

    /// <summary>
    /// Prefix used for OWS namespace
    /// </summary>
    public static string NSOWSPREFIX => _NSOWSPREFIX;

    /// <summary>
    /// OWS namespace URI 
    /// </summary>
    public static string NSOWS => _NSOWS;

    /// <summary>
    /// Prefix used for XML schema namespace
    /// </summary>
    public static string NSSCHEMAPREFIX => _NSSCHEMAPREFIX;

    /// <summary>
    /// XML schema namespace URI 
    /// </summary>
    public static string NSSCHEMA => _NSSCHEMA;
    ...
    /// </summary>
    public static string XPATH_TARGETNS => _XPATH_TARGETNS;
    ...
    /// </summary>
    public static string XPATH_GEOMETRYELEMENT_BYTYPEATTRIBUTEQUERY => _XPATH_GEOMETRYELEMENT_BYTYPEATTRIBUTEQUERY;

    /// <summary>
    /// Gets an XPath string addressing a name-attribute.
    /// </summary>
    public static string XPATH_NAMEATTRIBUTEQUERY => _XPATH_NAMEATTRIBUTEQUERY;

    /// <summary>
    ///  Gets an XPath string addressing a type-attribute.
    /// </summary>
    public static string XPATH_TYPEATTRIBUTEQUERY => _XPATH_TYPEATTRIBUTEQUERY;
    ...
    /// </summary>
    public static string XPATH_GEOMETRYELEMENTCOMPLEXTYPE_BYELEMREFQUERY => _XPATH_GEOMETRYELEMENTCOMPLEXTYPE_BYELEMREFQUERY;
    ...
    /// </summary>
    public static string XPATH_GEOMETRY_ELEMREF_GEOMNAMEQUERY => _XPATH_GEOMETRY_ELEMREF_GEOMNAMEQUERY;
    ...
    /// </summary>
    public static string XPATH_GEOMETRY_ELEMREF_GEOMNAMEQUERY_ANONYMOUSTYPE => _XPATH_GEOMETRY_ELEMREF_GEOMNAMEQUERY_ANONYMOUSTYPE;
    ...
    /// </summary>
    public static string XPATH_GEOMETRY_ELEMREF_GMLELEMENTQUERY => _XPATH_GEOMETRY_ELEMREF_GMLELEMENTQUERY;
