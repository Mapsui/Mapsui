...
public interface IXPathQueryManager
{
    ...
    {
        return SetDocumentToParseAsync(httpClientUtil, CancellationToken.None);
    }

    Task SetDocumentToParseAsync(HttpClientUtil httpClientUtil, CancellationToken cancellationToken);
}
