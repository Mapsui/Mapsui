...
namespace Mapsui.Layers
{
    public class RasterizingTileLayer : TileLayer
    {
        ...
        public RasterizingTileLayer(
            ...
            : base(new RasterizingTileProvider(layer, delayBeforeRasterize, renderResolutionMultiplier, rasterizer, overscanRatio, onlyRerasterizeIfOutsideOverscan, pixelDensity),
            minTiles,
            maxTiles,
            dataFetchStrategy,
            renderFetchStrategy,
