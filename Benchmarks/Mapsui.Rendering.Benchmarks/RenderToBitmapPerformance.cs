...
public class RenderToBitmapPerformance
{
    ...
    public async Task RenderDefaultAsync()
    {
        ...
        using var bitmap = mapRenderer.RenderToBitmapStream(map.Map.Navigator.State, map.Map!.Layers, Color.White);
#if DEBUG
    ...
    public async Task RenderRasterizingTilingPngAsync()
    {
        ...
        using var bitmap = mapRenderer.RenderToBitmapStream(pngMap.Map.Navigator.State, pngMap.Map!.Layers, Color.White);
#if DEBUG
    ...
    public async Task RenderRasterizingTilingWebPAsync()
    {
        ...
        using var bitmap = mapRenderer.RenderToBitmapStream(webpMap.Map.Navigator.State, webpMap.Map!.Layers, Color.White);
#if DEBUG
    ...
    public async Task RenderRasterizingTilingSkpAsync()
    {
        ...
        using var bitmap = mapRenderer.RenderToBitmapStream(skpMap.Map.Navigator.State, skpMap.Map!.Layers, Color.White);
#if DEBUG
