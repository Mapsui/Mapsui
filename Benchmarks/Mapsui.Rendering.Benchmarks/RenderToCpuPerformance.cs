...
public class RenderToCpuPerformance : IDisposable
{
    ...
    public static RegressionMapControl CreateMapControl(RenderFormat? renderFormat = null, bool tiling = true, bool rasterizing = false)
    {
        ...
        var resolution = ZoomHelper.ZoomOut(mapControl.Map.Navigator.Resolutions, mapControl.Map.Navigator.State.Resolution);
        mapControl.Map.Navigator.ZoomTo(resolution);

        // fetch data first time
        var fetchInfo = new FetchInfo(mapControl.Map.Navigator.State.ToSection(), mapControl.Map.CRS);
    ...
    public async Task RenderDefaultWithoutCacheAsync()
    {
        ...
        mapRendererWithoutCache.Render(skCanvas, map.Map.Navigator.State, map.Map.Layers, map.Map.Widgets, Color.White);
    }
    ...
    {
        await map.WaitForLoadingAsync();
        mapRenderer.Render(skCanvas, map.Map.Navigator.State, map.Map.Layers, map.Map.Widgets, Color.White);
    }
    ...
    public async Task RenderRasterizingPngAsync()
    {
        ...
        mapRenderer.Render(skCanvas, rasterizingPngMap.Map.Navigator.State, rasterizingPngMap.Map!.Layers, rasterizingPngMap.Map!.Widgets, Color.White);
    }
    ...
    public async Task RenderRasterizingSkpAsync()
    {
        ...
        mapRenderer.Render(skCanvas, rasterizingSkpMap.Map.Navigator.State, rasterizingSkpMap.Map!.Layers, rasterizingSkpMap.Map!.Widgets, Color.White);
    }
    ...
    public async Task RenderRasterizingTilingSkpAsync()
    {
        ...
        mapRenderer.Render(skCanvas, rasterizingTilingSkpMap.Map.Navigator.State, rasterizingTilingSkpMap.Map!.Layers, rasterizingTilingSkpMap.Map!.Widgets, Color.White);
    }
    ...
    public async Task RenderTilingPngAsync()
    {
        ...
        mapRenderer.Render(skCanvas, tilingPngMap.Map.Navigator.State, tilingPngMap.Map!.Layers, tilingPngMap.Map!.Widgets, Color.White);
    }
    ...
    public async Task RenderTilingWebPAsync()
    {
        ...
        mapRenderer.Render(skCanvas, tilingWebpMap.Map.Navigator.State, tilingWebpMap.Map.Layers, tilingWebpMap.Map.Widgets, Color.White);
    }
    ...
    public async Task RenderTilingSkpAsync()
    {
        ...
        mapRenderer.Render(skCanvas, tilingSkpMap.Map.Navigator.State, tilingSkpMap.Map.Layers, tilingSkpMap.Map.Widgets, Color.White);
    }
