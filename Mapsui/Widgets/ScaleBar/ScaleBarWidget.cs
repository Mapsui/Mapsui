...
public class ScaleBarWidget : Widget, INotifyPropertyChanged
{
    ...
    public (float scaleBarLength1, string? scaleBarText1, float scaleBarLength2, string? scaleBarText2)
        GetScaleBarLengthAndText(IViewportState viewport)
    {
    ...
    public IReadOnlyList<MPoint> GetScaleBarLinePositions(IViewportState viewport, float scaleBarLength1, float scaleBarLength2, float stroke)
    {
    ...
    /// </returns>
    public (float posX1, float posY1, float posX2, float posY2) GetScaleBarTextPositions(IViewportState viewport,
    ...
    private static (float scaleBarLength, string scaleBarText) CalculateScaleBarLengthAndValue(
        string CRS, IProjection projection, IViewportState viewport, float width, IUnitConverter unitConverter)
    {
