...
public class ZoomInOutWidget : TouchableWidget
{
    ...
    {
        if (name == nameof(Width) || name == nameof(Height) || name == nameof(Orientation))
        {
            Width = Orientation == Orientation.Vertical ? Size : 2 * Size;
            Height = Orientation == Orientation.Vertical ? 2 * Size : Size;
        }
