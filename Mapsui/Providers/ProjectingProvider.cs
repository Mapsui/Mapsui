...
namespace Mapsui.Providers
{
    public class ProjectingProvider : IProvider<GeometryFeature>
    {
        ...
        private readonly IGeometryProjection _geometryProjection;

        public ProjectingProvider(IProvider<GeometryFeature> provider, IGeometryProjection? geometryProjection = null)
        {
            _provider = provider;
            _geometryProjection = geometryProjection ?? new GeometryProjection();
        }
        ...
        {
            var projectedExtent = ProjectionHelper.Project(fetchInfo.Extent.ToBoundingBox(), _geometryProjection, CRS, _provider.CRS).ToMRect();
        ...
        public MRect GetExtent()
        {
            ...
            return ProjectionHelper.Project(_provider.GetExtent().ToBoundingBox(), _geometryProjection, _provider.CRS, CRS).ToMRect();
        }
    }
}
