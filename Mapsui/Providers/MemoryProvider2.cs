...
namespace Mapsui.Providers
{
    ...
    public class MemoryProvider2 : IProvider
    {
        ...
        public MemoryProvider2(IEnumerable<IGeometry> geometries)
        {
            CRS = "";
        ...
        public MemoryProvider2(IFeature feature)
        {
            CRS = "";
        ...
        public MemoryProvider2(string wellKnownTextGeometry)
        ...
        public MemoryProvider2(IEnumerable<IFeature> features)
        {
            CRS = "";
        ...
        public MemoryProvider2(Geometry geometry)
        {
            CRS = "";
        ...
        public MemoryProvider2(byte[] wellKnownBinaryGeometry) : this(GeometryFromWKB.Parse(wellKnownBinaryGeometry))
        {
        }
