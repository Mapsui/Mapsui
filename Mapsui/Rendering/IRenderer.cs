...
{
    void Render(object target, IViewportState viewport, IEnumerable<ILayer> layers, IEnumerable<IWidget> widgets, Color? background = null);
    MemoryStream RenderToBitmapStream(IViewportState viewport, IEnumerable<ILayer> layers,
