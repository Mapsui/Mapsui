...
namespace Mapsui
{
    public interface INavigator
    {
        ...
        void NavigateTo(BoundingBox extent, ScaleMethod scaleMethod = ScaleMethod.Fit, long duration = 0);
        ...
        void NavigateToFullEnvelope(ScaleMethod scaleMethod = ScaleMethod.Fill, long duration = 0);
        ...
        /// <param name="duration">Duration of animation in milliseconds</param>
        void ZoomTo(double resolution, long duration = 0);
        ...
        /// <param name="resolution">New resolution to use</param>
        /// <param name="duration">Duration of animation in milliseconds</param>
        void ZoomTo(double resolution, Point centerOfZoom, long duration = 0);
        ...
        /// <param name="duration">Duration of animation in milliseconds</param>
        void CenterOn(Point center, long duration = 0);
        ...
        /// <param name="duration">Duration of animation in milliseconds</param>
        void CenterOn(double x, double y, long duration = 0);
        ...
        /// <param name="duration">Duration of animation in milliseconds</param>
        void RotateTo(double rotation, long duration = 0);

        /// <summary>
        /// Zoom out to the next resolution
        /// </summary>
        /// <param name="duration">Duration of animation in milliseconds</param>
        void ZoomOut(long duration = 0);

        /// <summary>
        /// Zoom in to the next resolution
        /// </summary>
        /// <param name="duration">Duration of animation in milliseconds</param>
        void ZoomIn(long duration = 0);

        /// <summary>
        /// Zoom in about a given point
        /// </summary>
        /// <param name="centerOfZoom">Center to use for zoom in</param>
        void ZoomIn(Point centerOfZoom, long duration = 0);

        /// <summary>
        /// Zoom out about a given point
        /// </summary>
        /// <param name="centerOfZoom">Center to use for zoom in</param>
        void ZoomOut(Point centerOfZoom, long duration = 0);
        ...
        void FlingeWith(double velocityX, double velocityY, long maxDuration);
