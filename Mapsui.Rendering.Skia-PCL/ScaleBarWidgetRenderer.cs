    ...
    public static class ScaleBarWidgetRenderer
    {
            ...
            float layerOpacity)
        {
            ...
            else
            {
                ...
                paintScaleBarStroke.Color = scaleBar.BackColor.ToSkia(layerOpacity);
                ...
                paintScaleTextStroke.Color = scaleBar.BackColor.ToSkia(layerOpacity);
