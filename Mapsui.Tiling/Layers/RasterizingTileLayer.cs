...
/// </summary>
public class RasterizingTileLayer : TileLayer, ISourceLayer, ILayerDataFetcher, ILayerFeatureInfo
{
    /// <summary>
    ...
    public override void ViewportChanged(FetchInfo fetchInfo)
    {
        ...
        if (SourceLayer is ILayerDataFetcher layerDataFetcher)
            layerDataFetcher.ViewportChanged(fetchInfo);
    }
}
